...
const allBookingsData = [
  ...
  {
    id: 2,
    studentId: "2315001659",
    studentName: "Pratyaksh Gupta",
    hostel: "Block C",
    room: "204",
    date: "2026-02-15",
  },
  {
    id: 3,
    studentId: "2315001448",
    studentName: "Nayan Goyal",
    hostel: "Block A",
    room: "105",
    date: "2026-02-15",
  },
...
const AllBookings = () => {
  ...
  const filteredBookings = allBookingsData.filter((booking) => {
    const matchesSearch =
      booking.studentId.includes(searchTerm) ||
      booking.studentName.toLowerCase().includes(searchTerm.toLowerCase());
    const matchesFilter =
      hostelFilter === "all" || booking.hostel === hostelFilter;
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-slate-300 text-sm mt-1 font-medium">
              View and manage all confirmed room allocations.
            </p>
          </div>
        </div>
      </div>
            ...
            <tbody>
              {filteredBookings.length > 0 ? (
                ...
                <tr>
                  <td
                    colSpan="5"
                    className="text-center py-10 px-6 text-slate-400"
                  >
